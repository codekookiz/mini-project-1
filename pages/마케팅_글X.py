...
if marketing_class == "지역별":
    ...
    if region != "-":
        ...
        analysis = {
            "서울특별시": """
            - 1️⃣ 20대 중반이 가장 많이 구매 : 주 타겟층
                - 선호 차량 유형 : 중형 SUV/세단
            - 2️⃣ 전 연령대에 걸쳐 판매 가능성 : 40대부터 60대까지 꾸준한 소비
                - 선호 차량 유형 : 중형 SUV/세단
            - 3️⃣ 이미 130개 이상의 대리점/지점 존재
                - 전시장 확대보다는 더욱 다양한 차량 라인업 제공이 필요
            """,
            "경기도 수원시": """
            - 1️⃣ 40대 초반과 60대 중반이 가장 많이 구매 : 주 타겟층
                - 선호 차량 유형 : 준중형 세단
            - 2️⃣ 전반적으로 중형~준중형 사이즈 차량 수요 높음
                - 차종 역시 세단 선호도가 높음
            """,
            "울산광역시": """
            - 1️⃣ 30대 후반과 50대 중반 : 주 타겟층
                - 중형 SUV 선호
            - 2️⃣ 비교적 전 연령대에서 고른 구매 수요를 보임
                - 중형 SUV 및 세단 선호도 높음
            - 3️⃣ SUV의 선호도가 타지역에 비해 두드러짐
                - SUV 라인업 확대 필요
            """,
            "경기도 성남시": """
            - 1️⃣ 40대 초반과 50대 중후반 : 주 타겟층
                - 중형 세단 선호
            - 2️⃣ 40대 이상의 연령대에서 주된 구매 수요를 보임
                - 준중형/중형 세단 선호도 높음
            - 3️⃣ 30대 이하의 연령대에서 차량 구매 수요가 낮은 편
        ...
        if region == "서울특별시":
            ...
            st.write("""
            - **40대 이상 타겟 고객을 위한 금융 프로그램 제공**
            - **지역 기반 고객 대상 특별 리워드 프로그램 도입**
            - **저가형 모델 한정 프로모션 이벤트 실행**
            """)

        elif region == "충청남도 천안시":
            st.write("""
            - **지역 페스티벌 및 행사에서 차량 전시 및 체험 공간 제공**
...
- 전반적으로 친환경 차량에 대한 수요가 낮음
    ...
    if grade != "-":
        #  연령대 선택
        st.markdown("## 고객 등급별 차량 구매 분석 & 맞춤형 마케팅 전략")
        st.write("고객 등급별 차량 구매 성향을 분석하고 맞춤형 마케팅 전략을 제시합니다.")
