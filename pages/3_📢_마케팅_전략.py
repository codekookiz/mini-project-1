...
with col1:
    ...
    st.markdown("""
    **1. 고객 구매력 강화**  
    - 주요 카드사와의 전략적 제휴를 통한 자동차 판매 촉진  
    - 장기 무이자 할부 제공으로 구매 장벽 해소 및 판매 증대  
    - 카드 포인트 적립 및 사용 프로그램 운영으로 재구매율 상승  

    **2. 고객 유지비용 절감**  
    - 보험, 정비, 주유 등 유지비 할인 혜택 제공으로 부담 경감  
    - 전기차 대상 EV 충전 할인 혜택 지원으로 경쟁력 확보  
    """)

with col2:
    st.header("카드사 제휴 확대 예시")
    st.markdown("""
    - **현대카드, 롯데카드, 우리카드, 하나카드** 등 주요 카드사와 제휴 체결  
    - 카드사별 맞춤형 할부 및 포인트 적립 혜택 제공  
    - 할인 혜택 강화와 연계 프로모션으로 판매 촉진  
    - 전용 카드 혜택 지원을 통한 고객 충성도 및 브랜드 신뢰도 향상  
    """)
st.markdown("---")
