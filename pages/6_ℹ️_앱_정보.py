...
- 데이터 출처 : [현대자동차](https://block-edu.s3.ap-northeast-2.amazonaws.com/%EA%B3%A0%EA%B0%9Ddb_%ED%99%95%EC%9E%A5%EB%B3%B83.csv)
""")
...
st.write("""
### 데이터 전처리 주요 내용
- 기존 원본 데이터에는 불완전한 정보가 포함되어 있으며, 결측치 및 이상치가 존재
    - 
    - 
