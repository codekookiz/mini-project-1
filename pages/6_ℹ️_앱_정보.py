...
st.markdown("### 기대 효과")
desc_data = {
    "기대 효과" : ["고객 만족도 증가", "업무 자동화", "운영 비용 절감", "보안 강화"],
    "세부 내용" : ["맞춤형 프로모션 정보 제공을 통해 사용자 경험 개선", "영업사원이 프로모션을 쉽게 조회하고 고객에게 제공 가능", "데이터 분석 및 머신러닝 활용으로 최적의 혜택 제공", "환경 변수 관리 및 CI/CD 자동화를 통한 보안 유지"]
}
