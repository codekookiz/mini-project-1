...
if platform.system() == "Darwin":  # macOS
    ...
    font_path = "https://github.com/codekookiz/mini-project-1/fonts/NanumGothic.ttf"  # 맑은 고딕
    font_name = font_manager.FontProperties(fname=font_path).get_name()
    rc("font", family=font_name)
elif platform.system() == "Linux":  # Linux (Ubuntu, Docker 등)
    font_path = "https://github.com/codekookiz/mini-project-1/fonts/NanumGothic.ttf"  # 나눔고딕
    font_name = font_manager.FontProperties(fname=font_path).get_name()
    rc("font", family=font_name)
